...
class Login extends \Application\Entity\Login implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Login' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Login' . "\0" . 'created_at', '' . "\0" . 'Application\\Entity\\Login' . "\0" . 'player', '' . "\0" . 'Application\\Entity\\Login' . "\0" . 'logins');
        }
    ...
    public function setLogins(\Application\Entity\Login $logins = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLogins', array($logins));
