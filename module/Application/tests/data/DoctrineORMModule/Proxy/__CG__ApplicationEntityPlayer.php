...
class Player extends \Application\Entity\Player implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'genderOptions', '' . "\0" . 'Application\\Entity\\Player' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Player' . "\0" . 'username', '' . "\0" . 'Application\\Entity\\Player' . "\0" . 'password', '' . "\0" . 'Application\\Entity\\Player' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Player' . "\0" . 'age', '' . "\0" . 'Application\\Entity\\Player' . "\0" . 'gender', '' . "\0" . 'Application\\Entity\\Player' . "\0" . 'created_at', '' . "\0" . 'Application\\Entity\\Player' . "\0" . 'updated_at', '' . "\0" . 'Application\\Entity\\Player' . "\0" . 'wallets', '' . "\0" . 'Application\\Entity\\Player' . "\0" . 'surname', '' . "\0" . 'Application\\Entity\\Player' . "\0" . 'email');
        }
     ...
     * {@inheritDoc}
     */
    public function hasRealMoney()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasRealMoney', array());

        return parent::hasRealMoney();
    }

    /**
     * {@inheritDoc}
     */
    public function hasBonusMoney()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasBonusMoney', array());

        return parent::hasBonusMoney();
    }
